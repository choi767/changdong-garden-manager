...
describe("창동 틀밭관리 V2.4.1 업무 규칙", () => {
  ...
  it("관리표에는 같은 식물을 여러 번 등록할 수 있고 추가 표시명을 붙인다", () => {
    ...
    const displayNames = makeSheetPlantDisplayNameMap(sheetPlants.map((item) => ({ ...item, plant: { id: "p_1", name: "배추", normalizedName: "배추", category: "CROP" as const, plantingPeriod: "", seedlingPlantingPeriod: "", harvestPeriod: "", floweringPeriod: "", flowerColor: "", plantHeight: "", isVine: false, compoundFertilizer: "", oilCakeFertilizer: "", specializedFertilizer: "", topDressing: "", watering: "", sunlight: "UNKNOWN" as const, notes: "", imageDataUrl: "", imageMimeType: "", imageFileSize: 0, author: "", createdAt: "", updatedAt: "" } })));
  ...
  it("식물명은 공백 차이를 무시하고 중복을 막는다", () => {
    const data = createInitialData();
    data.plants.push({ id: "plant_1", name: "상추", normalizedName: "상추", category: "CROP", plantingPeriod: "", seedlingPlantingPeriod: "", harvestPeriod: "", floweringPeriod: "", flowerColor: "", plantHeight: "", isVine: false, compoundFertilizer: "", oilCakeFertilizer: "", specializedFertilizer: "", topDressing: "", watering: "", sunlight: "UNKNOWN", notes: "", imageDataUrl: "", imageMimeType: "", imageFileSize: 0, author: "사용자", createdAt: "", updatedAt: "" });
